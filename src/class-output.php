		...
		<div class="qm qm-non-tabular" id="qm-twig_profile">
			...
			if ( empty( $environment_profiles ) ) {
				...
				foreach ( $environment_profiles as $index => $environment_profile ) {
					...
					echo '<div><a href="https://actd.nl/query-monitor-twig-profile/?utm_source=qmtp&utm_medium=in_plugin&utm_campaign=documentation">' . esc_html__( 'Knowledge base and documentation', 'ndb_qm_twig' ) . '</a></div>';
					echo '</section>';
					echo '</div>';
				}
			}
